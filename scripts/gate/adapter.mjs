...
import { loadConfig, loadAdapter, ROOT, fail, notice } from './config.mjs';
...
// 任意の検査(secretScan など)は空でも通す。必須の検査は空を許さない
const OPTIONAL = new Set(['secretScan', 'lint', 'audit', 'licenses', 'coverage', 'install']);
